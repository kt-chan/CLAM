...
class Whole_Slide_Bag_FP(Dataset):
    def __init__(self, file_path, wsi_path, img_transforms=None):
        """
        Args:
                file_path (string): Path to the .h5 file containing patched data.
    ...
    def __getitem__(self, idx):
        ...
        img = (
            openslide.open_slide(self.wsi_path)
            .read_region(coord, self.patch_level, (self.patch_size, self.patch_size))
            .convert("RGB")
        )
